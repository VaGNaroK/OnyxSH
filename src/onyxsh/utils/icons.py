# onyxsh/utils/icons.py
"""
Icon loading utilities for OnyxSH.

Provides icon loading from bundled SVG files with proper symbolic icon
color adaptation via GTK's icon rendering system.

Usage:
    from onyxsh.utils.icons import icon_button, icon_image

    # These automatically use bundled icons when setting is 'onyxsh'
...
_ICON_PATHS = [
    "/usr/share/onyxsh/icons",
    str(Path(__file__).parent.parent / "icons"),  # src/onyxsh/icons
]
