# onyxsh/utils/logger.py
"""
Logging utilities for OnyxSH.
...
class LoggerConfig:
    ...
    def main_log_file(self) -> "Path":
        ...
        return self.log_dir / "onyxsh.log"

    @property
    def error_log_file(self) -> "Path":
        """Get error log file path."""
        return self.log_dir / "onyxsh_errors.log"
...
class LoggerManager:
    ...
    def enable_debug_mode(self):
        ...
        os.environ["ONYXSH_DEBUG"] = "1"

    def disable_debug_mode(self):
        self.set_console_level(LogLevel.INFO)
        os.environ.pop("ONYXSH_DEBUG", None)
...
def log_app_start():
    ...
    logger = get_logger("onyxsh.startup")
    logger.info("OnyxSH starting up")
    cleanup_old_logs()


def log_app_shutdown():
    """Log application shutdown."""
    logger = get_logger("onyxsh.shutdown")
    logger.info("OnyxSH shutting down")


def log_terminal_event(event_type: str, terminal_name: str, details: str = ""):
    """Log terminal-related events."""
    logger = get_logger("onyxsh.terminal")
...
def log_session_event(event_type: str, item_name: str, details: str = ""):
    ...
    logger = get_logger("onyxsh.sessions")
