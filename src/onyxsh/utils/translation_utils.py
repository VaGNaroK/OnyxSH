...
script_dir = os.path.dirname(os.path.abspath(__file__))  # .../onyxsh/utils
pkg_dir = os.path.dirname(script_dir)                    # .../onyxsh
repo_dir = os.path.dirname(pkg_dir)                      # root / repo dir

candidate_locale_dirs = [
    os.path.join(pkg_dir, 'locale'),                     # Internal app locale dir (e.g. /app/lib/onyxsh/locale)
    '/app/share/locale',                                 # Flatpak locale
    '/usr/share/locale',                                 # System package install
    '/usr/local/share/locale',                           # Local system install
    '/opt/onyxsh/locale',                          # /opt install
