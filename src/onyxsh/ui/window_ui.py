...
class WindowUIBuilder:
    ...
    def __init__(self, window: "CommTerminalWindow"):
        self.window = window
        self.logger = get_logger("onyxsh.ui.builder")
    ...
    def _setup_main_structure(self) -> Gtk.Box:
        ...
        self.sidebar_popover.add_css_class("onyxsh-popover")
    ...
    def _create_header_bar(self) -> Adw.HeaderBar:
        ...
        self.cleanup_popover.add_css_class("onyxsh-popover")
        ...
        self.single_tab_title_widget = Adw.WindowTitle(title="OnyxSH")
    ...
    def _on_toolbar_command_right_click(self, gesture, n_press, x, y, command):
        ...
        popover.add_css_class("onyxsh-popover")
