# onyxsh/ui/dialogs/preferences_dialog.py
...
class PreferencesDialog(Adw.PreferencesWindow):
    ...
    def __init__(self, parent_window, settings_manager: SettingsManager):
        ...
        self.logger = get_logger("onyxsh.ui.dialogs.preferences")
    ...
    def _setup_appearance_page(self) -> None:
        ...
        icon_theme_row.set_model(
            Gtk.StringList.new([_("OnyxSH Icons (Bundled)"), _("System Icons")])
        )
        current_strategy = self.settings_manager.get("icon_theme_strategy", "onyxsh")
        icon_strategy_index = 0 if current_strategy == "onyxsh" else 1
    ...
    def _on_icon_theme_changed(self, combo_row, _param) -> None:
        ...
        """
        index = combo_row.get_selected()
        strategy = "onyxsh" if index == 0 else "system"
