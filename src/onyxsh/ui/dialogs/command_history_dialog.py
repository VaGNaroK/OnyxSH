...
class CommandHistoryDialog(Gtk.Window):
    ...
    def __init__(
        ...
        self.logger = get_logger("onyxsh.ui.dialogs.command_history_dialog")
    ...
    def _detect_current_host(self) -> str:
        ...
        if self.current_terminal and hasattr(
            self.current_terminal, "onyxsh_session"
        ):
            sess = getattr(self.current_terminal, "onyxsh_session", None)
