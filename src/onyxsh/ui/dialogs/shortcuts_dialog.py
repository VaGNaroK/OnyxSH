# onyxsh/ui/dialogs/shortcuts_dialog.py
...
SHORTCUT_DATA = [
    ...
    },
    {
        ...
        "shortcuts": [
            ...
            ("focus-pane-up", _("Focus Pane Up")),
            ("focus-pane-down", _("Focus Pane Down")),
            ("focus-pane-left", _("Focus Pane Left")),
            ("focus-pane-right", _("Focus Pane Right")),
        ],
    },
    {
