...
logger = get_logger("onyxsh.ui.ssh_error_banner")
...
class SSHErrorBanner(Gtk.Box):
    ...
    def __init__(
        ...
        self.logger = get_logger("onyxsh.ui.ssh_error_banner")
...
class SSHErrorBannerManager:
    ...
    def __init__(self):
        self.logger = get_logger("onyxsh.ui.ssh_error_banner_manager")
