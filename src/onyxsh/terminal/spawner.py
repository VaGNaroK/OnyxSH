        ...
        if shell_basename == "zsh":
            try:
                ...
                zshrc_content = (
                    ...
                    '  printf "\\033]133;D;%d\\007\\033]133;A\\007\\033]6;file://localhost/__zt_sem__/D_%d_%s__A\\007\\033]0;__zt_sem__:D:%d;A\\007" "$exit_code" "$exit_code" "$b64_cmd" "$exit_code"\n'
                    '  _onyxsh_update_cwd\n'
                    '}\n'
                    '__onyxsh_semantic_preexec() {\n'
                    '  printf "\\033]133;C\\007\\033]6;file://localhost/__zt_sem__/C\\007\\033]0;__zt_sem__:C\\007"\n'
                    '}\n'
