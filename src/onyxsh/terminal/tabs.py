...
class TabManager:
    def __init__(
        ...
        """
        self.logger = get_logger("onyxsh.tabs.manager")
    ...
    def get_page_for_terminal(
        ...
        return getattr(terminal, "onyxsh_parent_page", None)
    ...
    def _split_terminal(
        ...
        with self._creation_lock:
            ...
            new_terminal.onyxsh_parent_page = page
