...
class SettingsValidator:
    ...
    def __init__(self):
        self.logger = get_logger("onyxsh.settings.validator")
...
class SettingsManager:
    ...
    _LOG_AREA = "onyxsh.settings"

    def __init__(self, settings_file: Optional[Path] = None):
        self.logger = get_logger("onyxsh.settings.manager")
    ...
    def _load_settings_safe(self) -> Dict[str, Any]:
        ...
        try:
            ...
            log_error_with_context(e, "settings loading", "onyxsh.settings")
            return self._defaults.copy()
            ...
            with self._lock:
                try:
                    ...
                    log_error_with_context(
                        e, "async settings saving", "onyxsh.settings"
                    )
                    self._dirty = True
    ...
    def _apply_gtk_terminal_theme_full(self, window) -> None:
        ...
        try:
            ...
            if luminance >= 0.05:
                ...
                css_parts.append(f"""
                popover.sidebar-popover.onyxsh-popover > contents,
                popover.sidebar-popover > contents {{
                    background-color: {bg_color};
                    padding: 0;
                }}
                popover.sidebar-popover.onyxsh-popover > arrow,
            ...
            if luminance >= 0.05:
                ...
                /* Specific onyxsh classes for backward compatibility */
                popover.onyxsh-popover > contents,
                popover.context-menu > contents {{
                    background-color: {header_bg_color};
                    color: {fg_color};
                }}
                popover.onyxsh-popover > arrow,
                ...
                .file-manager-main-box .file-manager-column-view row > *,
                .file-manager-main-box .file-grid-card > * {{
                    color: {fg_color};
                }}
                .file-manager-main-box .file-manager-column-view row,
                .file-manager-main-box .file-manager-column-view columnviewrow,
            ...
            if apply_dialog_bg:
                ...
                .onyxsh-dialog > toolbarview {{
                    background-color: {bg_color};
                }}
                .onyxsh-dialog > toolbarview > contents {{
                    background-color: {bg_color};
                }}
                .onyxsh-dialog scrolledwindow {{
                    background-color: {bg_color};
                }}
                .onyxsh-dialog scrolledwindow > viewport {{
                    background-color: {bg_color};
                }}
                .onyxsh-dialog .navigation-view,
                .onyxsh-dialog .preferences-page {{
                    background-color: {bg_color};
                    color: {fg_color};
                }}
                .onyxsh-dialog .preferences-group {{
                    background-color: {header_bg_color};
                    color: {fg_color};
                }}
                .onyxsh-dialog > toolbarview label,
                .onyxsh-dialog .preferences-page label,
                .onyxsh-dialog row label,
                .onyxsh-dialog .title,
                .onyxsh-dialog .subtitle,
                .onyxsh-dialog button:not(.suggested-action):not(.destructive-action),
                .onyxsh-dialog entry,
                .onyxsh-dialog row,
                .onyxsh-dialog switch,
                .onyxsh-dialog spinbutton,
                .onyxsh-dialog dropdown,
                .onyxsh-dialog checkbutton,
                ...
                .onyxsh-dialog actionbar,
                .onyxsh-dialog actionbar > revealer,
                .onyxsh-dialog actionbar > revealer > box {{
                    background: {header_bg_color};
                    background-color: {header_bg_color};
                    color: {fg_color};
                }}
                ...
                .onyxsh-dialog button.destructive-action {{
                    background-color: #c01c28;
                    background-image: none;
                    color: #ffffff;
                    border: none;
                }}
                .onyxsh-dialog button.destructive-action:hover {{
                    background-color: #a51d2d;
                }}
                .onyxsh-dialog button.destructive-action label {{
                    color: #ffffff;
                }}
                
                /* Flat button styling */
                .onyxsh-dialog button.flat {{
                    color: {fg_color};
                }}
                .onyxsh-dialog button.flat:hover {{
                    background-color: color-mix(in srgb, {fg_color} {hover_alpha}, {bg_color});
                }}
    ...
    # ------------------------------------------------------------------
    # Theme handling aligned with onyxsh: single provider + ThemeEngine.
    # Keep onyxsh public API names used by window/dialog modules.
    # ------------------------------------------------------------------
