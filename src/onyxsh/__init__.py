...
def main() -> int:
    ...
    logger = logger_mod.get_logger("onyxsh.main")
    ...
    try:
        ...
        setproctitle.setproctitle("onyxsh")
        logger.info("Process title set to 'onyxsh'.")
    except Exception as e:
    ...
    parser = argparse.ArgumentParser(
        prog="onyxsh",
        description=_(
            "OnyxSH - A modern terminal emulator with session management"
        ),
        epilog=_("For more information, visit: https://github.com/VaGNaroK/OnyxSH/"),
    )
    ...
    try:
        ...
        alert.set_detail(_("Could not start OnyxSH.\n\nError: {}").format(e))
