...
class OpenRouterProvider(LLMProvider):
    ...
    def __init__(self, config: dict[str, Any]) -> None:
        ...
        self.site_url = config.get("openrouter_site_url", "https://github.com/VaGNaroK/zashterminal-Fork")
        self.site_name = config.get("openrouter_site_name", "Zashterminal")
        self.logger = get_logger("zashterminal.agent.providers.openrouter")
