...
NEW_TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "Profiles and Data": {
        "pt": "Perfis e Dados",
        "en": "Profiles and Data",
        "es": "Perfiles y Datos",
        "fr": "Profils et Données",
        "de": "Profile und Daten",
        "it": "Profili e Dati",
        "zh": "配置文件与数据",
        "ja": "プロファイルとデータ",
        "ru": "Профили и данные",
    ...
    "Sempre restaurar": {
        "pt": "Sempre restaurar",
        "en": "Always restore",
        "es": "Siempre restaurar",
        "fr": "Toujours restaurer",
        "de": "Immer wiederherstellen",
        "it": "Ripristina sempre",
        "zh": "始终恢复",
        "ja": "常に復元",
        "ru": "Всегда восстанавливать",
    },
    "Perguntar ao iniciar": {
        "pt": "Perguntar ao iniciar",
        "en": "Ask on startup",
        "es": "Preguntar al iniciar",
        "fr": "Demander au démarrage",
        "de": "Beim Start fragen",
        "it": "Chiedi all'avvio",
        "zh": "启动时询问",
        "ja": "起動時に確認",
        "ru": "Спрашивать при запуске",
    },
    "Nunca restaurar": {
        "pt": "Nunca restaurar",
        "en": "Never restore",
        "es": "Nunca restaurar",
        "fr": "Ne jamais restaurer",
        "de": "Nie wiederherstellen",
        "it": "Non ripristinare mai",
        "zh": "从不恢复",
        "ja": "復元しない",
        "ru": "Никогда не восстанавливать",
    },
